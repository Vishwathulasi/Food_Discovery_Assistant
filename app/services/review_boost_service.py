...
def _short_review_summary(reviews_text: str, max_len: int = 140) -> str:
    """
    Return ONLY positive review highlights.
    Filters out negative sentences using simple keyword rules.
    """
    ...
    # Negative keywords (skip these sentences)
    negative_markers = [
    ...
    # If NO positive review exists → return empty summary
    if not positive_sentences:
        return ""

    # Pick the first positive sentence
